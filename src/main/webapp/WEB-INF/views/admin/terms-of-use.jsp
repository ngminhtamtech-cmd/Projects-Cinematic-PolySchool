...
<head>
    ...
    <title>Thỏa thuận sử dụng - Admin CineBook</title>
    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-content">
            ...
            <section class="portal-head">
                <div>
                    <h1>Quản lý Thỏa thuận sử dụng</h1>
                    <p class="muted">Chỉnh sửa, xem trước và xuất bản Thỏa thuận sử dụng trang web an toàn cho người dùng CineBook.</p>
                </div>
            </section>
            ...
            <div class="policy-editor-grid">
                ...
                <div class="policy-panel">
                    <div class="policy-panel-header">
                        <h2 class="policy-panel-title">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#2563EB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/admin/content/terms-of-use">
                        <cb:csrf/>
                        <div class="policy-form-group">
                            <label><span style="color:#ef4444;font-weight:bold;margin-right:2px;">*</span>Tiêu đề thỏa thuận</label>
                            <input type="text" name="title" required maxlength="255" value="<c:out value='${empty policyDraft ? policyPublished.title : policyDraft.title}'/>" placeholder="Thỏa thuận sử dụng trang web an toàn...">
                        </div>

                        <div class="policy-form-group">
                            <label><span style="color:#ef4444;font-weight:bold;margin-right:2px;">*</span>Nội dung quy định sử dụng</label>
                            <textarea name="bodyText" required placeholder="Nhập từng điều khoản quy định sử dụng..."><c:out value="${empty policyDraft ? policyPublished.bodyText : policyDraft.bodyText}"/></textarea>
                        </div>
                        ...
                        <div class="policy-actions">
                            ...
                            <button type="submit" name="action" value="publish" class="btn-primary" style="height:38px;padding:0 18px;font-weight:600;background:#2563EB;" onclick="return confirm('Bạn có chắc chắn muốn XUẤT BẢN phiên bản Thỏa thuận sử dụng mới này không?')">
                ...
                <div class="policy-panel">
                    <div class="policy-panel-header">
                        ...
                        <a href="${pageContext.request.contextPath}/thoa-thuan-su-dung" target="_blank" rel="noopener" class="btn-secondary" style="font-size:12px;padding:4px 10px;height:auto;display:inline-flex;align-items:center;gap:4px;">
